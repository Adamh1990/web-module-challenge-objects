...
console.log(createMenuItem("hot dog", 4, "Lunch"));
console.log(createMenuItem("fries", 2, "Lunch"));
...
export const burger = {
  ...
  price: 18, 
  category: "Lunch", 
  discount: function discount(str) {
...
*/
reviews.push({name: "Adam", rating: 9, feedback: "It's a burger joint"});
